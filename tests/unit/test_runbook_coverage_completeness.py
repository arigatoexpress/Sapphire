...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("`services/security_pipeline/`", "security-pipeline-runbook.md", 3),
        ...
        ("`com.sapphire.security-pipeline`", "security-pipeline-runbook.md", 3),
        ("`com.sapphire.gcp-sync`", "gcp-pipeline-runbook.md", 3),
        ("`com.sapphire.heartbeat`", "heartbeat-runbook.md", 3),
        ("`com.sapphire.logrotate`", "logrotate-runbook.md", 3),
        ("`com.sapphire.market-intel`", "market-intel-runbook.md", 3),
        ("`com.sapphire.morning-brief`", "morning-brief-runbook.md", 3),
        ("`com.sapphire.openbb-api`", "openbb-api-runbook.md", 3),
        ("`com.sapphire.self-optimization`", "self-optimization-runbook.md", 3),
        ("`com.sapphire.morning-digest` (service-local)", "morning-digest-runbook.md", 3),
...
def test_tranche7_runbook_uplift_surfaces_are_no_longer_score_one(
    ...
    row = rows[surface]
    assert runbook in row["runbook"], f"{surface} should cite {runbook}, got {row['runbook']!r}"
