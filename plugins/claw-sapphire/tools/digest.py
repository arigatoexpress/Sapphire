#!/usr/bin/env python3
"""Compat shim — real implementation in tools/internal/digest.py.

Keeps the historical `plugins/claw-sapphire/tools/digest.py` invocation path
...
_TARGET = Path(__file__).parent / "internal" / "digest.py"
