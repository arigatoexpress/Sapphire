#!/usr/bin/env python3
"""Compat shim — real implementation in tools/internal/backtest.py.

Keeps the historical `plugins/claw-sapphire/tools/backtest.py` invocation path
...
_TARGET = Path(__file__).parent / "internal" / "backtest.py"
