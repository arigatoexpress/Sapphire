#!/usr/bin/env python3
"""Compat shim — real implementation in tools/internal/predict.py.

Keeps the historical `plugins/claw-sapphire/tools/predict.py` invocation path
...
_TARGET = Path(__file__).parent / "internal" / "predict.py"
