#!/usr/bin/env python3
"""Compat shim — real implementation in tools/internal/lumo.py.

Keeps the historical `plugins/claw-sapphire/tools/lumo.py` invocation path
...
_TARGET = Path(__file__).parent / "internal" / "lumo.py"
