#!/usr/bin/env python3
"""Compat shim — real implementation in tools/internal/events.py.

Keeps the historical `plugins/claw-sapphire/tools/events.py` invocation path
...
_TARGET = Path(__file__).parent / "internal" / "events.py"
