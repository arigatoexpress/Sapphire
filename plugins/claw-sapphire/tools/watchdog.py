#!/usr/bin/env python3
"""Compat shim — real implementation in tools/internal/watchdog.py.

Keeps the historical `plugins/claw-sapphire/tools/watchdog.py` invocation path
...
_TARGET = Path(__file__).parent / "internal" / "watchdog.py"
