...
[![Tests](https://img.shields.io/badge/tests-6%2C571%2B%20passing-2ea44f)](https://github.com/arigatoexpress/Sapphire/actions/workflows/ci.yml)
...
|---|---:|---|
| Passing tests | **6,571+** | 6,078+ unit · 493 plugin (`python scripts/ops/test_inventory.py --check-readme`) |
| Test files | **381+** | `tests/unit/` and `plugins/claw-sapphire/tests/` |
...
| Plugin tools (registered · internal · deprecated) | **9 · 59 · 1** | 69 total entries in `infra/tool-registry.yaml` |
