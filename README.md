...
[![Tests](https://img.shields.io/badge/tests-7%2C025%2B%20passing-2ea44f)](scripts/ops/test_inventory.py)
...
|---|---:|---|
| Passing tests | **7,025+** | 6,430+ unit · 595 plugin (`scripts/ops/test_inventory.py --check-readme`) |
| Test files | **419+** | `tests/unit/` and `plugins/claw-sapphire/tests/` |
...
```bash
# 7,025+ tests · 419 files · CI-enforced
