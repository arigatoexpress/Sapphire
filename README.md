...
[![Tests](https://img.shields.io/badge/tests-6%2C729%2B%20passing-2ea44f)](scripts/ops/test_inventory.py)
...
|---|---:|---|
| Passing tests | **6,729+** | 6,162+ unit · 567 plugin (`scripts/ops/test_inventory.py --check-readme`) |
...
```bash
# 6,729 tests · 390 files · CI-enforced
