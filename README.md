...
[![Tests](https://img.shields.io/badge/tests-7%2C024%2B%20passing-2ea44f)](scripts/ops/test_inventory.py)
...
|---|---:|---|
| Passing tests | **7,024+** | 6,429+ unit · 595 plugin (`scripts/ops/test_inventory.py --check-readme`) |
...
```bash
# 7,024+ tests · 419 files · CI-enforced
