...
[![Tests](https://img.shields.io/badge/tests-5%2C228%2B%20passing-2ea44f)](https://github.com/arigatoexpress/Sapphire/actions/workflows/ci.yml)
...
|---|---:|---|
| Passing tests | **5,228+** | 4,849+ unit · 379 plugin (`python scripts/ops/test_inventory.py --check-readme`) |
...
```bash
# Unit tests — 4,849 collected; latest full run: 4,828 passed, 1 skipped, 20 xfailed
/usr/local/bin/python3 -m pytest tests/unit/ --tb=short -q

# Plugin tests — 379 collected; latest full run: 379 passed
