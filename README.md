...
[![Tests](https://img.shields.io/badge/tests-7%2C000%2B%20passing-2ea44f)](scripts/ops/test_inventory.py)
...
|---|---:|---|
| Passing tests | **7,000+** | 6,405+ unit · 595 plugin (`scripts/ops/test_inventory.py --check-readme`) |
| Test files | **411+** | `tests/unit/` and `plugins/claw-sapphire/tests/` |
