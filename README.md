...
[![Tests](https://img.shields.io/badge/tests-6%2C487%2B%20passing-2ea44f)](https://github.com/arigatoexpress/Sapphire/actions/workflows/ci.yml)
...
|---|---:|---|
| Passing tests | **6,487+** | 5,994+ unit · 493 plugin (`python scripts/ops/test_inventory.py --check-readme`) |
| Test files | **375+** | `tests/unit/` and `plugins/claw-sapphire/tests/` |
