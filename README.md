...
[![Tests](https://img.shields.io/badge/tests-5%2C930%2B%20passing-2ea44f)](https://github.com/arigatoexpress/Sapphire/actions/workflows/ci.yml)
...
|---|---:|---|
| Passing tests | **5,930+** | 5,467+ unit · 463 plugin (`python scripts/ops/test_inventory.py --check-readme`) |
| Test files | **338+** | `tests/unit/` and `plugins/claw-sapphire/tests/` |
