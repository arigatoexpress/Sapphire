...
[![Tests](https://img.shields.io/badge/tests-6%2C990%2B%20passing-2ea44f)](scripts/ops/test_inventory.py)
...
|---|---:|---|
| Passing tests | **6,990+** | 6,395+ unit · 595 plugin (`scripts/ops/test_inventory.py --check-readme`) |
| Test files | **409+** | `tests/unit/` and `plugins/claw-sapphire/tests/` |
