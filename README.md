...
[![Tests](https://img.shields.io/badge/tests-7%2C004%2B%20passing-2ea44f)](scripts/ops/test_inventory.py)
...
|---|---:|---|
| Passing tests | **7,004+** | 6,409+ unit · 595 plugin (`scripts/ops/test_inventory.py --check-readme`) |
| Test files | **413+** | `tests/unit/` and `plugins/claw-sapphire/tests/` |
