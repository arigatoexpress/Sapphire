...
[![Tests](https://img.shields.io/badge/tests-6%2C946%2B%20passing-2ea44f)](scripts/ops/test_inventory.py)
...
|---|---:|---|
| Passing tests | **6,946+** | 6,351+ unit · 595 plugin (`scripts/ops/test_inventory.py --check-readme`) |
| Test files | **414+** | `tests/unit/` and `plugins/claw-sapphire/tests/` |
...
flowchart LR
    ...
    Bus --> Dashboard[Dashboard · 50 pages<br/>SSE · /showcase]:::edge
...
```bash
# 6,946+ tests · 414 files · CI-enforced
