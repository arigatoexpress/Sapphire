...
[![Tests](https://img.shields.io/badge/tests-6%2C723%2B%20passing-2ea44f)](https://github.com/arigatoexpress/Sapphire/actions/workflows/ci.yml)
...
|---|---:|---|
| Passing tests | **6,723+** | 6,156+ unit · 567 plugin (`python scripts/ops/test_inventory.py --check-readme`) |
| Test files | **390+** | `tests/unit/` and `plugins/claw-sapphire/tests/` |
