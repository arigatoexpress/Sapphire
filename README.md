...
[![Tests](https://img.shields.io/badge/tests-6%2C488%2B%20passing-2ea44f)](https://github.com/arigatoexpress/Sapphire/actions/workflows/ci.yml)
...
|---|---:|---|
| Passing tests | **6,488+** | 5,995+ unit · 493 plugin (`python scripts/ops/test_inventory.py --check-readme`) |
