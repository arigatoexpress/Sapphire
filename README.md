...
[![Tests](https://img.shields.io/badge/tests-5%2C236%2B%20passing-2ea44f)](https://github.com/arigatoexpress/Sapphire/actions/workflows/ci.yml)
...
|---|---:|---|
| Passing tests | **5,236+** | 4,858+ unit · 378 plugin (`python scripts/ops/test_inventory.py --check-readme`) |
| Test files | **283+** | `tests/unit/` and `plugins/claw-sapphire/tests/` |
...
```bash
# Unit tests — 4,858 collected; latest full run: 4,837 passed, 1 skipped, 20 xfailed
