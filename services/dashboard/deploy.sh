...
echo "  /platform              - Platform Reliability"
echo "  /control               - Control Plane"
echo "  /activity              - Unified Activity Stream"
echo "  /sapphire-book         - Sapphire Book"
echo "  /settings              - Settings"
echo
echo "Legacy aliases (redirect):"
echo "  /trading /feed         -> /intelligence"
echo "  /system-health /infrastructure /production-readiness -> /platform"
echo "  /logs                  -> /activity"
echo "  /projects              -> /organization#programs"
