...
5. **Operations** ("show proposals", "pending code", "health check", "sync roadmap", "ci status", "openclaw status", "ping agents", "smoke test", "agent status", "dispatch stats")
   - Intent: `operations`
   - Params:
     - `action`: "PROPOSALS", "DIFF", "APPROVE_PROPOSAL", "REJECT_PROPOSAL", "HEALTH", "ROADMAP_SYNC", "CI_STATUS", "OPENCLAW_STATUS", "OPENCLAW_SMOKE", "AGENT_STATUS"
