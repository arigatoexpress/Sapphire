...
Note: Enhanced features available in cloud_trader.execution.risk_manager
This module maintains backward compatibility while exposing enhanced classes.
"""
...
# Import enhanced classes from execution module for forward compatibility
# These provide additional features like SizingMethod, RiskLimits, PositionSize, RiskAssessment
try:
    from cloud_trader.execution.risk_manager import (
        SizingMethod,
        RiskLimits,
        PositionSize,
        RiskAssessment,
        RiskManager as EnhancedRiskManager
    )
    __all__ = ['Position', 'RiskLevel', 'RiskManager', 'SizingMethod', 'RiskLimits',
               'PositionSize', 'RiskAssessment', 'EnhancedRiskManager']
except ImportError:
    __all__ = ['Position', 'RiskLevel', 'RiskManager']
