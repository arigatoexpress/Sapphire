...
_Count: 14 · by_status: {'live': 8, 'monorepo_ready_plant_pending': 1, 'paper_only_not_armed_until_p0': 1, 'read_only': 1, 'dry_run_default': 1, 'plant': 1, 'policy_in_monorepo': 1}_

| id | surface | status | action |
|---|---|---|---|
| `grok-drive-pack` | monorepo+drive | live | Build sanitized Drive pack → Sapphire/Grok Bridge folders |
