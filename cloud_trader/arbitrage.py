...
class ArbitrageEngine:
    ...
    async def scan_opportunities(self, market: Dict[str, MarketSnapshot]) -> List[ArbitrageOpportunity]:
    ...
    async def _scan_funding_arbitrage(self, market: Dict[str, MarketSnapshot]) -> List[ArbitrageOpportunity]:
    ...
    async def _scan_triangular_arbitrage(self, market: Dict[str, MarketSnapshot]) -> List[ArbitrageOpportunity]:
    ...
    async def _scan_cross_symbol_arbitrage(self, market: Dict[str, MarketSnapshot]) -> List[ArbitrageOpportunity]:
    ...
    async def execute_arbitrage(self, opportunity: ArbitrageOpportunity) -> bool:
        ...
        try:
            ...
            if execution_time > self._max_execution_time:
                logger.warning(f"Arbitrage execution took {execution_time:.3f}s, may have missed opportunity")
    ...
    async def _execute_funding_arbitrage(self, opportunity: ArbitrageOpportunity) -> bool:
        ...
        logger.info(f"Funding arbitrage opportunity: {opportunity.metadata['direction']} "
    ...
    async def _execute_triangular_arbitrage(self, opportunity: ArbitrageOpportunity) -> bool:
        ...
        # For MVP, log the opportunity
        logger.info(f"Triangular arbitrage: {opportunity.metadata['path']} "
    ...
    async def _execute_cross_symbol_arbitrage(self, opportunity: ArbitrageOpportunity) -> bool:
        ...
        logger.info(f"Pairs arbitrage: {opportunity.metadata['action']} "
                   f"for {opportunity.expected_profit:.3f}% profit")
        return True
