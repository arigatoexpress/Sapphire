...
class TradingLogger(SapphireLogger):
    ...
    def log_signal_received(self, signal_id: str, symbol: str, action: str, 
                           source: str = "tradingview", **kwargs):
    ...
    def log_signal_validated(self, signal_id: str, symbol: str, 
                            validation_result: dict, **kwargs):
    ...
    def log_signal_published(self, signal_id: str, symbol: str, 
                            channel: str, message_id: str, **kwargs):
    ...
    def log_signal_error(self, signal_id: str, error: str, 
                        stage: str, **kwargs):
    ...
    def log_trade_executed(self, trade_id: str, signal_id: str, 
...
class WebhookLogger(SapphireLogger):
    ...
    def log_request_received(self, request_id: str, client_ip: str, 
    ...
    def log_request_validated(self, request_id: str, validation_result: bool, 
                             **kwargs):
    ...
    def log_ollama_enrichment(self, request_id: str, symbol: str, 
                             verdict: str, latency_ms: float, **kwargs):
    ...
    def log_response_sent(self, request_id: str, status_code: int, 
                         signal_id: str = None, **kwargs):
...
class SelfImprovementLogger(SapphireLogger):
    ...
    def log_task_created(self, review_id: str, task_id: str, 
                        priority: str, assignee: str, **kwargs):
    ...
    def log_review_completed(self, review_id: str, tasks_created: int, 
                           **kwargs):
