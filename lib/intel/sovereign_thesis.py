...
SOURCE_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "chain:economic_activity": {
        "provider": "chain",
        "connector_id": "chain_economic_activity",
        "configured": True,
        "cadence": "daily/research",
    },
    "crypto:post_quantum_roadmap": {
        "provider": "crypto",
        "connector_id": "post_quantum_research",
        "configured": True,
        "cadence": "manual/research",
    },
    "ethereum:account_abstraction": {
        "provider": "ethereum",
        "connector_id": "ethereum_account_abstraction",
        "configured": True,
        "cadence": "manual/research",
    },
    "ethereum:eip_tracker": {
        "provider": "ethereum",
        "connector_id": "ethereum_eips",
        "configured": True,
        "cadence": "manual/research",
    },
    "ethereum:l2_economy": {
        "provider": "ethereum",
        "connector_id": "ethereum_l2_economy",
        "configured": True,
        "cadence": "manual/research",
    },
    "ethereum:post_quantum": {
        "provider": "ethereum",
        "connector_id": "ethereum_quantum_resistance",
        "configured": True,
        "cadence": "manual/research",
    },
    "ethereum:privacy_cluster": {
        "provider": "ethereum",
        "connector_id": "ethereum_privacy_cluster",
        "configured": True,
        "cadence": "manual/research",
    },
    "ethereum:protocol_roadmap": {
        "provider": "ethereum",
        "connector_id": "ethereum_roadmap",
        "configured": True,
        "cadence": "manual/research",
    },
    "ethereum:zero_knowledge": {
        "provider": "ethereum",
        "connector_id": "ethereum_zk_research",
        "configured": True,
        "cadence": "manual/research",
    },
    "fred:FEDFUNDS": {
    ...
    "privacy:protocol_design": {
        "provider": "privacy",
        "connector_id": "privacy_protocol_design",
        "configured": True,
        "cadence": "manual/research",
    },
    "protocol:upgrade_roadmap": {
        "provider": "protocol",
        "connector_id": "protocol_upgrade_tracker",
        "configured": True,
        "cadence": "manual/research",
    },
    "provider:globalx": {
