...
| 5 | 2026-07-12T12:47Z | schedule | [29193259289](https://github.com/arigatoexpress/Sapphire/actions/runs/29193259289) | FAIL | 1 | 0 | market_pulse body length delta 0.58 (local 128 chars vs remote 308 chars) exceeds FAIL threshold; x.quality and x.file hash also drift. |
| 6 | 2026-07-13T13:55Z | schedule | [29255771812](https://github.com/arigatoexpress/Sapphire/actions/runs/29255771812) | FAIL | 2 | 0 | Body length drift exceeds 50% threshold for market_pulse and weekly_crypto_brief (up to 66%), with rendered file hash drift across x, linkedin, and substack platforms. Report: `data/content/shadow-reports/content-shadow-comparison-20260714T130650Z.json`. |
| 7 | 2026-07-14T13:00Z | schedule | [29334694275](https://github.com/arigatoexpress/Sapphire/actions/runs/29334694275) | FAIL | 1 | 0 | market_pulse body length delta 58% (local 128 chars vs remote 308 chars) exceeds FAIL threshold; remote X quality check passed where local failed (too_short); stale local market_pulse draft vs fresh remote output. |
