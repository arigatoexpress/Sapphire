...
| 12 | 2026-08-08T12:20Z | schedule | [31257017014](https://github.com/arigatoexpress/Sapphire/actions/runs/31257017014) | FAIL | 1 | 0 | market_pulse body-length delta 58% (remote 308 chars vs local 128 chars); x quality diverges (local too_short, remote data_density_low + evidence_coverage_low) — persistent pattern from prior cycles. Report: `data/content/shadow-reports/content-shadow-comparison-20260808T130736Z.json`. |
| 13 | 2026-08-09T12:21Z | schedule | [31313094196](https://github.com/arigatoexpress/Sapphire/actions/runs/31313094196) | FAIL | 1 | 0 | market_pulse body-length delta 58% (remote 308 chars vs local 128 chars); x quality diverges (local too_short, remote data_density_low + evidence_coverage_low) — persistent pattern from prior cycles. Report: `data/content/shadow-reports/content-shadow-comparison-20260810T131252Z.json`. |
| 14 | 2026-08-11T12:35Z | schedule | [31491958664](https://github.com/arigatoexpress/Sapphire/actions/runs/31491958664) | FAIL | 1 | 0 | market_pulse body-length delta 58% (remote 308 chars vs local 128 chars); x quality diverges (local too_short, remote data_density_low + evidence_coverage_low) — persistent pattern from prior cycles. |
| 15 | 2026-08-12T12:38Z | schedule | [31597392463](https://github.com/arigatoexpress/Sapphire/actions/runs/31597392463) | FAIL | 2 | 0 | ai_intel substack quality fails (evidence_coverage_low, argument_coherence_low) and market_pulse body-length delta 58% (remote 308 chars vs local 128 chars); x quality diverges (local too_short, remote data_density_low + evidence_coverage_low) — persistent pattern from prior cycles. Report: `data/content/shadow-reports/content-shadow-comparison-20260812T132018Z.json`. |
| 16 | 2026-08-13T12:39Z | schedule | [31701057718](https://github.com/arigatoexpress/Sapphire/actions/runs/31701057718) | FAIL | 1 | 0 | market_pulse body-length delta 58% (remote 308 chars vs local 128 chars); x quality diverges (local too_short, remote data_density_low + evidence_coverage_low) — persistent pattern from prior cycles. Report: `data/content/shadow-reports/content-shadow-comparison-20260813T131758Z.json`. |
