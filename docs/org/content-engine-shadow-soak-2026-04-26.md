...
| 2 | 2026-06-07T13:40Z | schedule | [27094217909](https://github.com/arigatoexpress/Sapphire/actions/runs/27094217909) | FAIL | 1 | 0 | market_pulse body length delta 58.4% (local 128 chars from stale 2026-04-17 draft vs remote 308 chars from 2026-06-07 run) exceeds the 50% FAIL threshold; x.quality and x.file diffs are WARN only. |
