...
| 12 | 2026-08-07T12:34Z | schedule | [31178783545](https://github.com/arigatoexpress/Sapphire/actions/runs/31178783545) | FAIL | 2 | 0 | market_pulse body-length delta 58% (remote 308 chars vs local 128 chars) and security_digest body-length delta 78% (remote 3381 chars vs local 754 chars); security_digest substack fails quality (citation_quality_low, argument_coherence_low) — persistent body drift across market_pulse, security_digest on all platforms. |
