...
|---|---|
| `/Users/aribs/Code/Sapphire/docs/diligence/screenshots/dashboard-showcase.md` | `/showcase` unified dashboard with Sapphire route cards, satellite frontend links, and safety posture visible |
