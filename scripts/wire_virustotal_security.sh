...
Optional env vars:
  ...
  SAPPHIRE_VT_MAX_SKILLS_PER_SCAN=1..200
  SAPPHIRE_VT_MAX_REQUESTS_PER_MINUTE=1..60
  SAPPHIRE_VT_MAX_REQUESTS_PER_DAY=1..50000
USAGE
}
...
gcloud run services update "$SERVICE_NAME" \
  ...
  --update-env-vars "SAPPHIRE_VT_MAX_REQUESTS_PER_DAY=${SAPPHIRE_VT_MAX_REQUESTS_PER_DAY}" >/dev/null
