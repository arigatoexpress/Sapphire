...
JOB_NAME="${JOB_NAME:-sapphire-architecture-bottleneck-digest-hourly}"
SCHEDULE="${SCHEDULE:-42 * * * *}"
...
HOURS="${HOURS:-6}"
MIN_INTERVAL_SEC="${MIN_INTERVAL_SEC:-3600}"
FORCE="${FORCE:-false}"
...
TARGET_URL="${TARGET_URL:-${SERVICE_URL%/}/jobs/platform/architecture-bottleneck-digest}"
...
BODY="{\"hours\":${HOURS},\"min_interval_sec\":${MIN_INTERVAL_SEC},\"force\":${FORCE}}"
