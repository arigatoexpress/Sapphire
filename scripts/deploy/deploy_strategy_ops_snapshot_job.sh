...
JOB_NAME="${JOB_NAME:-sapphire-strategy-ops-snapshot-hourly}"
...
TARGET_URL="${TARGET_URL:-${SERVICE_URL%/}/jobs/platform/strategy-ops-snapshot}"
...
BODY="{\"days\":${DAYS},\"keep_history\":${KEEP_HISTORY},\"refresh\":${REFRESH}}"
