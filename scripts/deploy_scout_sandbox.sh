...
SCOUT_SANDBOX_INTEL_GLINT_BEARER_TOKEN_SECRET="${SCOUT_SANDBOX_INTEL_GLINT_BEARER_TOKEN_SECRET:-SAPPHIRE_GLINT_API_BEARER_TOKEN}"
...
SCOUT_SANDBOX_INTEL_ENABLED="${SCOUT_SANDBOX_INTEL_ENABLED:-true}"
SCOUT_SANDBOX_INTEL_ALLOWED_HOSTS="${SCOUT_SANDBOX_INTEL_ALLOWED_HOSTS:-glint.trade,www.glint.trade}"
SCOUT_SANDBOX_INTEL_GLINT_API_URL="${SCOUT_SANDBOX_INTEL_GLINT_API_URL:-https://api.glint.trade/api/feed/v2}"
ENV_DELIM="^@^"
...
gcloud run deploy "${SERVICE_NAME}" \
  ...
  --timeout "120" \
  --port "8080" \
  --update-env-vars "${ENV_DELIM}GCP_PROJECT_ID=${PROJECT_ID}@SCOUT_SANDBOX_DRY_RUN=${SCOUT_SANDBOX_DRY_RUN}@SCOUT_SANDBOX_AUTO_VERIFY_ENABLED=${SCOUT_SANDBOX_AUTO_VERIFY_ENABLED}@SCOUT_SANDBOX_ALLOWED_HOSTS=${SCOUT_SANDBOX_ALLOWED_HOSTS}@SCOUT_SANDBOX_INTEL_ENABLED=${SCOUT_SANDBOX_INTEL_ENABLED}@SCOUT_SANDBOX_INTEL_ALLOWED_HOSTS=${SCOUT_SANDBOX_INTEL_ALLOWED_HOSTS}@SCOUT_SANDBOX_INTEL_GLINT_API_URL=${SCOUT_SANDBOX_INTEL_GLINT_API_URL}"
...
if has_secret "${SCOUT_SANDBOX_INTEL_GLINT_BEARER_TOKEN_SECRET}"; then
  SECRET_MAPPINGS+=("SCOUT_SANDBOX_INTEL_GLINT_BEARER_TOKEN=${SCOUT_SANDBOX_INTEL_GLINT_BEARER_TOKEN_SECRET}:latest")
fi
