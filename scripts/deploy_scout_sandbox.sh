...
SCOUT_SANDBOX_ALLOWED_HOSTS_ESCAPED="${SCOUT_SANDBOX_ALLOWED_HOSTS//,/\\,}"
...
gcloud run deploy "${SERVICE_NAME}" \
  ...
  --update-env-vars "SCOUT_SANDBOX_DRY_RUN=${SCOUT_SANDBOX_DRY_RUN}" \
  --update-env-vars "SCOUT_SANDBOX_AUTO_VERIFY_ENABLED=${SCOUT_SANDBOX_AUTO_VERIFY_ENABLED}" \
  --update-env-vars "SCOUT_SANDBOX_ALLOWED_HOSTS=${SCOUT_SANDBOX_ALLOWED_HOSTS_ESCAPED}"
