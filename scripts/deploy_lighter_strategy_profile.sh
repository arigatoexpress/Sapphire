...
case "$PROFILE" in
  ...
  overnight_exploration)
    ...
    KV[LIGHTER_ALLOWED_STRATEGIES]="luxalgo_msb_ob,smart_money_breakout,algoalpha_smb,chartprime_tbt,trendline_breakout_targets,overnight_ema_crossover"
    KV[LIGHTER_ALLOWED_TIMEFRAMES]="1m,5m,15m,1h,4h,1d"
    KV[LIGHTER_STRATEGY_REQUIRE_METADATA]="true"
    KV[LIGHTER_SINGLE_SYMBOL_MODE]="false"
    KV[LIGHTER_MAX_ORDER_NOTIONAL_USD]="4"
    ...
    KV[LIGHTER_SYNC_BEFORE_ENTRY]="true"
    KV[LIGHTER_JURISDICTION_BLOCK_SECONDS]="900"
    KV[LIGHTER_ENTRY_COOLDOWN_SECONDS]="45"
    ...
    KV[LIGHTER_OPPORTUNITY_MIN_EDGE_PCT]="0.05"
