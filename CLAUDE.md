...
```bash
# Test
/usr/local/bin/python3 -m pytest tests/unit/ --tb=short -q   # 1,111 tests (prefer /usr/local/bin/python3)
/usr/local/bin/python3 -m pytest plugins/claw-sapphire/tests/ -q   # 25 plugin tests
/usr/local/bin/python3 -m pytest tests/integration/ -q       # 4 integration suites
